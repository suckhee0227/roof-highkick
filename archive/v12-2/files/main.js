...
function onStopClick(e) {
  ...
  sounds["click"]?.play();
  if (btnStopEl) {
    gsapWithCSS.to(btnStopEl, { scale: 0.9, yoyo: true, repeat: 1, duration: 0.1 });
  }
  timeUp(true);
}
...
function onStartClick() {
  ...
  if (btn) {
    gsapWithCSS.to(btn, { scale: 1.1, duration: 0.15, yoyo: true, repeat: 1, onComplete: showTurnPopup });
  }
}
